...
/* package gloss-pacman-0.1.0.0 */
#ifndef VERSION_gloss_pacman
#define VERSION_gloss_pacman "0.1.0.0"
#endif /* VERSION_gloss_pacman */
#ifndef MIN_VERSION_gloss_pacman
#define MIN_VERSION_gloss_pacman(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_gloss_pacman */
...
#define CURRENT_COMPONENT_ID "gloss-pacman-0.1.0.0-inplace-gloss-counter"
