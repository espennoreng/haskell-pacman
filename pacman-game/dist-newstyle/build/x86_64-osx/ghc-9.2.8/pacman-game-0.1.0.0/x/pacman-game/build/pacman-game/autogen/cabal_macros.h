...
/* package pacman-game-0.1.0.0 */
#ifndef VERSION_pacman_game
#define VERSION_pacman_game "0.1.0.0"
#endif /* VERSION_pacman_game */
#ifndef MIN_VERSION_pacman_game
#define MIN_VERSION_pacman_game(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pacman_game */
...
#define CURRENT_COMPONENT_ID "pacman-game-0.1.0.0-inplace-pacman-game"
